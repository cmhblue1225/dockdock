 ...
 *         description: 서버 오류
 */
router.post('/report/generate', authenticate, onboardingController.generateOnboardingReport);
 ...
 *         description: 서버 오류
 */
router.get('/report', authenticate, onboardingController.getOnboardingReport);

// TODO: 레포트 재생성 기능은 추후 구현
// router.post('/report/regenerate', authenticate, onboardingController.regenerateOnboardingReport);
